...
var starter = (function (exports) {
  ...
  function make_move$prime(position, move) {
    return make_move(position, move, 0);
  }

  function check_or_checkmate(position, move) {
    var position$prime = make_move(position, move, 0);
    var checked$$1 = king_checked(position$prime, position$prime[/* turn */1]);
    if (checked$$1) {
      var match = legal_moves(position$prime);
      if (match) {
        return /* Check */0;
      } else {
        return /* Checkmate */1;
  ...
  function unify(value, hint) {
    if (hint !== undefined && !caml_equal(value, valFromOption(hint))) {
      return false;
    } else {
      return true;
    }
  ...
  function san_of_move$prime(position, move_list, move) {
    ...
    if (short_move_option !== undefined) {
      ...
      san = _6(sprintf(/* Format */[
                ...
                "%c%s%s%s%c%c"
              ]), char_of_piece_type(match[0]), file_hint !== undefined ? _1(sprintf(/* Format */[
                      /* Char */__(0, [/* End_of_format */0]),
                      "%c"
                    ]), get("abcdefgh", file_hint)) : "", rank_hint !== undefined ? _1(sprintf(/* Format */[
                      /* Char */__(0, [/* End_of_format */0]),
                      "%c"
                    ]), get("12345678", rank_hint)) : "", match[4] ? "x" : "", get("abcdefgh", match$1[0]), get("12345678", match$1[1]));
    } else {
        ...
        case 1 : 
            ...
            san = _4(sprintf(/* Format */[
                      ...
                      "%s%c%c%s"
                            ...
                            "%cx"
                          ]), get("abcdefgh", long_move$1[0])) : "", get("abcdefgh", match$2[0]), get("12345678", match$2[1]), promotion !== undefined ? _1(sprintf(/* Format */[
                            /* Char_literal */__(12, [
                                /* "=" */61,
                                /* Char */__(0, [/* End_of_format */0])
                              ]),
                            "=%c"
                          ]), char_of_piece_type(promotion)) : "");
            break;
        case 2 : 
  ...
  var Illegal_move$1 = Illegal_move;
    ...
    var jump_fwd = function (_position, _zipper, _n) {
      while(true) {
        ...
        if (n <= 0) {
          ...
          _n = n - 1 | 0;
          _zipper = match[1];
          _position = make_move$prime(position, match[0][/* move */0]);
          continue ;
        }
      }  };
  ...
  function update(model, param$$1) {
    if (typeof param$$1 === "number") {
      ...
      var move = param$$1[0];
      try {
        var san = san_of_move(model[/* position */0], move);
        var position = make_move$1(model[/* position */0], move, 0);
        return /* tuple */[
                /* record */[
                  /* position */position,
                  /* moves */fwd$prime(/* record */[
                        /* move */move,
                        /* san */san
                      ], model[/* moves */1])
                ],
  ...
  function move_list_view(ply, param$$1) {
    ...
    var move_list_future_view = function (ply, future) {
      ...
      while(true) {
        ...
        if (param$$1) {
          ...
          return function (acc) {
            return _1(cont, /* :: */[
                        move_view(undefined, ply, offset, hd$$1),
                        acc
                      ]);
          }
          }(offset,cont,hd$$1));
    ...
    var loop = function (_offset, _acc, _param) {
      while(true) {
        ...
        if (param$$1) {
          _param = param$$1[1];
          _acc = /* :: */[
            move_view(offset === 0, ply, offset, param$$1[0]),
            acc
          ];
          _offset = offset - 1 | 0;
          continue ;
    ...
    return ul(undefined, undefined, /* :: */[
                ...
                loop(0, move_list_future_view(ply, param$$1[1]), param$$1[0])
              ]);
  }

  function status_view(position) {
    var match = game_status$1(position);
    var tmp;
    if (typeof match === "number") {
      tmp = "It's a draw!";
    } else if (match.tag) {
      ...
      tmp = _2(sprintf(/* Format */[
              ...
              ]), match$1 ? "White" : "Black", length(match[0]));
    } else {
  ...
  var flip_button_view = button(undefined, undefined, /* :: */[
        onClick(/* Internal_msg */__(0, [/* Flip_board */0])),
        /* [] */0
      ], /* :: */[
        text$1("Flip board"),
        /* [] */0
  ...
  var partial_arg$2 = Decoder[/* map3 */18]((function (a$$1, b$$1, c) {
          return /* tuple */[
                  a$$1,
                  b$$1,
                  c
  ...
  function offset_page_size(param$$1) {
    return partial_arg$3(partial_arg$2, param$$1);
  }

  function handler(decoder, msg$$1, $$event) {
    var match = _1(decoder, $$event);
    if (match.tag) {
      return undefined;
    } else {
      return some(_1(msg$$1, match[0]));
    }
  }

  function filter_targets(source$$1, moves$$1) {
    return map((function (param$$1) {
                  return /* tuple */[
                          param$$1[0][1],
                          param$$1[1]
                        ];
                }), filter((function (param$$1) {
                        return caml_equal(param$$1[0][0], source$$1);
                      }))(moves$$1));
  }
  ...
  function coordinate_pairs$1(turn, move) {
    return /* tuple */[
            coordinate_pairs(turn, move),
            completed_move(move)
          ];
  }
  ...
  function move_start(interactable) {
    if (interactable) {
      ...
      return /* tuple */[
              turn,
              (function (file, rank, param$$1) {
                  var coordinates = param$$1[1];
                  return /* Internal_msg */__(0, [/* Move_start */__(0, [/* record */[
                                  ...
                                  /* legal_targets */filter_targets(/* tuple */[
                                        file,
                                        rank
                                      ], map((function (param$$1) {
                                              return coordinate_pairs$1(turn, param$$1);
                                            }), legal_moves)),
                                  /* initial */coordinates,
                                  /* offset */param$$1[0],
  ...
  function board_view(interactable, pos_ar, model) {
    ...
    var drag_transform = function (drag) {
      return style$2("transform", _2(sprintf(/* Format */[
                          /* String_literal */__(11, [
                              "translate(",
                              /* Int */__(4, [
                                  /* Int_d */0,
    ...
    var target_highlight = function (drag, target$$1) {
      ...
      if (match !== undefined && caml_equal(match, target$$1)) {
        return true;
      } else {
        return false;
      }
    ...
    var legal_highlight = function (drag, target$$1) {
      return exists((function (param$$1) {
                    return caml_equal(param$$1[0], target$$1);
      ...
      return node$1(undefined, "cb-row", undefined, undefined, /* [] */0, map((function (param$$1) {
                        ...
                        if (match) {
                          ...
                          if (match$5 !== undefined) {
                            var match$6 = match$5;
                            if (color === match$6[0]) {
                              var partial_arg = _2(match$6[1], file, rank$1);
                              tmp = onCB$1("mousedown", "", (function (param$$1) {
                                      return handler(offset_page_size, partial_arg, param$$1);
                                    }));
                            } else {
                              tmp = noProp$1;
                            }
                          ...
                          match$1 = /* tuple */[
                            node$1(undefined, "cb-piece", undefined, undefined, /* :: */[
                                  match$4[1],
                                  /* :: */[
                                    classList(/* :: */[
                                          /* tuple */[
                        ...
                        if (typeof match$7 === "number" || match$7.tag) {
                          ...
                          tmp$1 = /* :: */[
                            ...
                            /* :: */[
                              onMouseEnter(/* Internal_msg */__(0, [/* Square_entered */__(3, [/* tuple */[
                                            file,
                                            rank$1
                                          ]])])),
                              /* :: */[
                                onMouseLeave(/* Internal_msg */__(0, [/* Square_left */__(4, [/* tuple */[
                                              file,
                                              rank$1
                                            ]])])),
                                /* [] */0
                        ...
                        return node$1(undefined, "cb-square", undefined, undefined, /* :: */[
                                    match$1[1],
                                    tmp$1
                                  ], /* :: */[
                                    match$1[0],
  ...
  function view$1(interactable, pos_ar, model) {
    var promo_view = function (promoting) {
      ...
      var left = match$2[0];
      var promo_piece_view = function (param$$1) {
        var piece_type = param$$1[1];
        return node$1(undefined, "cb-square", undefined, undefined, /* :: */[
                    onClick(/* Internal_msg */__(0, [/* Piece_promoted */__(5, [piece_type])])),
                    /* :: */[
                      styles$1(/* :: */[
                            /* tuple */[
                              "left",
                            ...
                            /* :: */[
                              /* tuple */[
                                ...
                                _1(sprintf(/* Format */[
                                          ...
                                          "%dpx"
                                        ]), imul(param$$1[0], promoting[/* size */3]))
                              ],
                              /* [] */0
                            ]
                          ]),
      ...
      return node$1(undefined, "cb-promo", undefined, undefined, /* :: */[
                  onClick(/* Internal_msg */__(0, [/* Promotion_canceled */1])),
                  /* [] */0
                ], map(promo_piece_view, combine(match$2[1], /* :: */[
                          /* Queen */1,
                          /* :: */[
                            /* Knight */4,
                            /* :: */[
    ...
    return node$1(undefined, "cb-wrap", undefined, undefined, /* [] */0, /* :: */[
                tmp,
                /* :: */[
    ...
    if (param$$1.tag) {
      ...
      if (typeof msg$$1 === "number") {
        if (msg$$1 === 0) {
          return /* tuple */[
                  /* record */[
                    /* orientation */opposite_color$1(model[/* orientation */0]),
                    /* state */model[/* state */1]
                  ],
                  none
                ];
        ...
        switch (msg$$1.tag | 0) {
          ...
          case 2 : 
              if (typeof match === "number" || match.tag) {
                ...
                if (match$1 !== undefined) {
                  var target$$1 = match$1;
                  try {
                    var match$2 = assoc(target$$1, drag$1[/* legal_targets */3]);
                    if (match$2) {
                      return /* tuple */[
                              /* record */[
                                /* orientation */model[/* orientation */0],
  ...
  function subscriptions(model) {
    ...
    if (typeof match === "number" || match.tag) {
      ...
      return batch$1(/* :: */[
                  moves(undefined, (function (x) {
                          return /* Internal_msg */__(0, [/* Move_drag */__(1, [x])]);
                        })),
                  /* :: */[
                    ups(undefined, (function (x) {
  ...
  function $$int$3(min, max) {
    return /* Generator */[(function (state) {
                return min + State[/* int */4](state, max - min | 0) | 0;
              })];
  }
  ...
  function random_move(param_0) {
    return /* Random_move */__(2, [param_0]);
  }

  function key_pressed(param_0) {
    return /* Key_pressed */__(3, [param_0]);
  }
  ...
  function update$2(model, param$$1) {
    if (typeof param$$1 === "number") {
      var match = game_status$1(model[/* game */0][/* position */0]);
      var tmp;
      if (typeof match === "number" || !match.tag) {
        tmp = none;
      } else {
        ...
        tmp = generate((function (random_number) {
                return /* Random_move */__(2, [nth(move_list, random_number)]);
      ...
      switch (param$$1.tag | 0) {
        case 0 : 
            ...
            if (msg$$1.tag) {
              return /* tuple */[
                      model,
                      msg(/* Game_msg */__(1, [/* Move */__(0, [msg$$1[0]])]))
                    ];
            } else {
              var match$1 = update$1(model[/* board */1], msg$$1);
              return /* tuple */[
                      /* record */[
                        /* game */model[/* game */0],
                        /* board */match$1[0]
        ...
        case 1 : 
            var match$2 = update(model[/* game */0], param$$1[0]);
            return /* tuple */[
                    /* record */[
                      /* game */match$2[0],
                      /* board */model[/* board */1]
                    ],
                    map$5(game_msg, match$2[1])
                  ];
        case 2 : 
            return /* tuple */[
                    model,
                    msg(/* Game_msg */__(1, [/* Move */__(0, [param$$1[0]])]))
                  ];
        case 3 : 
            var key_event$$1 = param$$1[0];
            var match$3 = key_event$$1[/* ctrl */2];
            var match$4 = key_event$$1[/* key_code */0];
            var tmp$1;
            var exit = 0;
            if (match$3) {
              if (match$4 !== 66) {
                if (match$4 !== 70) {
                  ...
                  tmp$1 = msg(/* Game_msg */__(1, [/* Forward */1]));
                }
              } else {
                tmp$1 = msg(/* Game_msg */__(1, [/* Take_back */0]));
              }
            } else {
              exit = 1;
            }
  ...
  function view$2(model) {
    ...
    return div$2(undefined, undefined, /* [] */0, /* :: */[
                map$8(board_msg, view$1(interactable$$1, model[/* game */0][/* position */0][/* ar */0], model[/* board */1])),
                /* :: */[
                  p(undefined, undefined, /* [] */0, /* :: */[
                        ...
                        /* :: */[
                          ...
                          /* :: */[
                            button(undefined, undefined, /* :: */[
                                  onClick(/* Game_msg */__(1, [/* Take_back */0])),
                                  /* [] */0
                                ], /* :: */[
                                  text$1("Take back"),
                                  /* [] */0
                  ...
                  /* :: */[
                    map$8(game_msg, view(model[/* game */0])),
                    /* [] */0
                  ]
                ]
              ]);
  ...
  function subscriptions$1(model) {
    return batch$1(/* :: */[
                map$7(board_msg, subscriptions(model[/* board */1])),
                /* :: */[
                  downs$1(undefined, key_pressed),
                  /* [] */0
                ]
              ]);
  }

  var partial_arg$4 = /* record */[
    /* init */init$7,
    /* update */update$2,
    /* view */view$2,
  ...
  function main$3(param$$1, param$1) {
    return standardProgram(partial_arg$4, param$$1, param$1);
  }
  ...
  exports.view = view$2;
  exports.subscriptions = subscriptions$1;
  exports.main = main$3;
